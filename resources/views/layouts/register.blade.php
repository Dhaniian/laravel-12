...
<body>
  ...
  <div class="container">
    <div class="register-container">
      ...
      <div class="alert alert-danger" style="display: none;" id="errorAlert">
        <ul id="errorList">
          <!-- Errors will be populated here by Laravel -->
        </ul>
      </div>
      ...
      <form action="{{ route('daftar') }}" method="post" onsubmit="return validatePasswords()">
        ...
        <div class="password-error" id="password-error">Password tidak cocok!</div>
        ...
        <div class="form-check">
          ...
          <label class="form-check-label" for="agreeTerms">
            Saya setuju dengan <a href="#" style="color: #00c6ff;">syarat dan ketentuan</a>
          </label>
        </div>
  ...
  <script>
    ...
    // Ensure inputs always have white text color
    document.addEventListener('DOMContentLoaded', function() {
      ...
      // Show errors if they exist (for Laravel integration)
      @if ($errors->any())
