...
<head>
  ...
  <title>Register | RSKurangSehat</title>
  ...
  <style>
    * {
    ...
    /* Specific styling for name and password fields */
    ...
    /* Placeholder color for name and password fields */
    #name::placeholder, #password::placeholder, #password_confirmation::placeholder {
    ...
    .form-select {
      ...
      transition: all 0.3s ease;
      font-size: 0.95rem;
      /* Removed the dropdown arrow background image */
...
<body>
  ...
  <div class="container">
    <div class="register-container">
      ...
      <form method="POST" action="{{ url('/register') }}">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control @error('no_hp') is-invalid @enderror" id="no_hp" name="no_hp"
                 value="{{ old('no_hp') }}" placeholder="Nomor Handphone" required>
        </div>
        ...
        <div class="form-group">
          ...
          <i class="fas fa-eye toggle-password" id="eye-icon-1" onclick="togglePassword('password', 'eye-icon-1')"></i>
        </div>
        ...
        <div class="form-group">
          ...
          <i class="fas fa-eye toggle-password" id="eye-icon-2" onclick="togglePassword('password_confirmation', 'eye-icon-2')"></i>
        </div>
      ...
      <!-- Simple navigation without any arrows or chevrons -->
      <div class="nav-container">
        <button class="btn btn-register" style="margin-top: 20px; max-width: 200px; margin-left: auto; margin-right: auto;">
          LANJUT
        </button>
      </div>
    </div>
  ...
  <script>
    ...
    // Remove any arrow elements that might be injected by Bootstrap or other scripts
    document.addEventListener('DOMContentLoaded', function() {
      // Find and remove any chevron/arrow elements
      const arrows = document.querySelectorAll('.fa-chevron-down, .chevron, [class*="arrow"]');
